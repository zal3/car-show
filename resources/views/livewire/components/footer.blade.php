<section class="bg-black bg-opacity-70  shadow-full shadow-black shadow-lg">
    <div class="max-w-screen-xl mx-2 overflow-hidden ">
        <div class="md:flex-col  flex md:py-2 justify-center items-center ">
            <a href="#" class="text-white mx-1 my-2  hover:text-gray-900">
