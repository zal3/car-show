<div class="overflow-y-hidden ">
    ...
    <div class="flex justify-center mx-auto items-center">
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7   gap-12 justify-center mx-auto items-center mt-20 mb-8">
                    ...
                    <div class="front" style="background-image: url(https://unsplash.it/500/500/)">
                        <div class="inner">
                            <div class="card-front__tp card-front__tp--city">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-engine" width="48" height="48" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="front" style="background-image: url(https://unsplash.it/503/503/)">
                        <div class="inner">
                            <div class="card-front__tp card-front__tp--camping">
                                <svg style="color: white" xmlns="http://www.w3.org/2000/svg" id="car-rental" width="48" height="48" viewBox="0 0 15 15">
                                    <path d="M12.6,8.7,11.5,6.5a1.05,1.05,0,0,0-.9-.5H4.4a1.05,1.05,0,0,0-.9.5L2.4,8.7,1.16,9.852a.5.5,0,0,0-.16.367V14.5a.5.5,0,0,0,.5.5h2c.2,0,.5-.2.5-.4V14h7v.5c0,.2.2.5.4.5h2.1a.5.5,0,0,0,.5-.5V10.219a.5.5,0,0,0-.16-.367ZM4.5,7h6l1,2h-8ZM5,11.6c0,.2-.3.4-.5.4H2.4c-.2,0-.4-.3-.4-.5V10.4c.1-.3.3-.5.6-.4l2,.4c.2,0,.4.3.4.5Zm8-.1c0,.2-.2.5-.4.5H10.5c-.2,0-.5-.2-.5-.4v-.7c0-.2.2-.5.4-.5l2-.4c.3-.1.5.1.6.4ZM13.5,0H11a1,1,0,0,0-1,1H2L1,2V3L2,4,3.5,2.5,5,4,6.5,2.5,8,4h2a1,1,0,0,0,1,1h2.5a.5.5,0,0,0,.5-.5V.5A.5.5,0,0,0,13.5,0ZM13,3.5a.5.5,0,0,1-1,0v-2a.5.5,0,0,1,1,0Z" fill="white"></path>
                                </svg>
                                <h2 class="card-front__heading">
                                    تاجير سيارة
                                </h2>
            ...
            <div class=" grid grid-cols-1 md:grid-cols-3  justify-center items-center  gap-6 ">
                <div class="w-full max-w-sm     rounded-br-3xl rounded-tl-3xl  ">
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-14 h-14 md:w-24 md:h-24 mb-3 mt-3 border border-gray-600 rounded-full shadow-lg" src="{{ asset('img/team/girl1 1.png') }}" alt="Bonnie image" />
                ...
                <div class="w-full max-w-sm     ">
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-14 h-14 md:w-24 md:h-24 mb-3 mt-3 rounded-full border border-gray-600 shadow-lg" src="{{ asset('img/team/girl2 1.png') }}" alt="Bonnie image" />
                ...
                <div class="w-full max-w-sm     ">
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-14 h-14 md:w-24 md:h-24 mb-3 mt-3 border border-gray-600 rounded-full shadow-lg" src="{{ asset('img/team/girl3 1.png') }}" alt="Bonnie image" />
