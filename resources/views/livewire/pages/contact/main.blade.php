                            ...
                            <div class=" block rounded-lg shadow-lg px-6 py-12  lg:-mr-14"
                                ...
                                <form wire:submit.prevent="add" action="" class="form contact-form" method="post">
                                    <input wire:model.lazy="name" type="text"
                                        class="input border-r-0 border-l-0 border-t-0 w-full  bg-transparent border-b-black font-normal block pl-0 focus:ring-0 "
                                        placeholder="الاسم" required name="name">
                                    <span class="bar"></span>
                                    <input wire:model.lazy="email" type="email"
                                        class="input border-r-0 border-l-0 border-t-0 w-full  bg-transparent border-b-black font-normal block pl-0 focus:ring-0 "
                                        placeholder="ايميل" required name="email">
                                    <span class="bar"></span>
                                    <input wire:model.lazy="title" type="text"
                                        class="input border-r-0 border-l-0 border-t-0 w-full  bg-transparent border-b-black font-normal block pl-0 focus:ring-0 "
                                        placeholder="العنوان" required name="titsubject">
                                    <span class="bar"></span>
                                    <textarea wire:model.lazy="subject"
                                        class="input border-r-0 border-l-0 border-t-0 w-full  bg-transparent border-b-black font-normal block pl-0 focus:ring-0 "
                                        cols="30" rows="8" placeholder="الموضوع" required name="subject"></textarea>
                                    <span class="bar"></span>
                                    <button type="submit"
                        ...
                        <div class="md:mb-12 lg:mb-0">
                            <div class="map-container relative shadow-lg rounded-lg">
                                <iframe
                                    ...
                                    class="left-0 top-0  w-full absolute rounded-lg hh" frameborder="0"
