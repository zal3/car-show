<div>
    <article class="hov bg-gray mr-5 pb-2  w-60  bg-gray-200 relative ">
        ...
        <a class="absolute pr-4 z-1 w-16 text-white bg-red-600 p-2  rounded-b-full rounded-l-full ">تاجير</a>
        @endif
        ...
        <div class="box ">
            <a href="{{ route('car-page', ['car_id' => $car->id]) }}" class=" flex justify-between  p-3 bg-black text-white car  ">
